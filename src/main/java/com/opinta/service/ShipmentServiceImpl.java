...
public class ShipmentServiceImpl implements ShipmentService {
    ...
    public ShipmentDto save(ShipmentDto shipmentDto) {
        ...
        shipment.setPrice(calculateAll(shipment));
    ...
    public ShipmentDto update(long id, ShipmentDto shipmentDto) {
        ...
        target.setId(id);
        target.setPrice(calculateAll(target));
    ...
    @Override
    public BigDecimal calculateAll(Shipment shipment) {
      BigDecimal price = BigDecimal.ZERO;
      List<Parcel> parcels = shipment.getParsels();
      for (Parcel parcel: parcels){
          price = price.add(parcel.getPrice());
      }
        return price;
    }
